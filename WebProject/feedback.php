...
<div class="col-lg-6">
<span class="logo">Moodle Simulator</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
{
echo '<a href="logout.php?q=feedback.php" class="pull-right sub1 btn title3"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Log Out</a>&nbsp;';}
?>
...
<h2 allign="center" style="font-family:'typo'; color:#000066">FEEDBACK/REPORT A PROBLEM</h2>
<div style="font-size:14px">
<?php 
if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 
You can send us your feedback through the following email address:<br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<a href="mailto:12033442@students.liu.edu.lb" style="color:#000000">12033442@students.liu.edu.lb</a><br /><br />
...
<a href="http://www.liu.edu.lb" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/ALI.jpg" width=100 height=149 alt="Ali Hammoud" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/profile.php?id=100007649655655" style="color:#202020; font-family:'typo' ; font-size:18px">Ali Hammoud</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+961 71177861</h4>
		<h4 style="font-family:'typo' ">12033442@students.liu.edu.lb</h4>
		<h4 style="font-family:'typo' ">Lebanese International University</h4></div></div>
		</p>
      </div>
